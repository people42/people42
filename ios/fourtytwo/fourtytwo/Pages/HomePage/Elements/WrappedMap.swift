...
//                }
//                
//                if pointAnnotation.status == "writing" {
//                    view.image = UIImage(named: "ellipsis.bubble")
//                } else {
//                    view.image = nil
//                }
//
...
//                      let emoji = nearUser["emoji"] as? String,
//                      let status = nearUser["status"] as? String else {
//                    continue
//                }
//
...
//                annotation.status = status // 추가된 코드
