...
class ChangeEmojiAdapter(private val context: Context) : RecyclerView.Adapter<ChangeEmojiAdapter.EmojiViewHolder>() {
    ...
    override fun onBindViewHolder(holder: EmojiViewHolder, position: Int) {
        val pickedEmoji = "https://peoplemoji.s3.ap-northeast-2.amazonaws.com/emoji/animate/${emojiNameList[position]}.gif"
        Glide.with(context)
            .load(pickedEmoji)
            .into(holder.emojiView)
        holder.emojiView.setOnClickListener {
            onItemClickListener.onItemClicked(it, emojiNameList[position], position)
        }
    }
